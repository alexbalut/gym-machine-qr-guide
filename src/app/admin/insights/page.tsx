...
export default async function InsightsPage() {
  ...
  return (
    <main className="mx-auto max-w-6xl px-4 py-8">
      ...
      <div className="card p-5 mb-8 border-cyan-400/20 bg-cyan-400/5">
        <p className="text-sm font-semibold text-cyan-200 mb-1">Pitch language</p>
                ...
                {topMachines.map((m, i) => (
                  <tr key={m.id} className="border-b border-border/60 last:border-0">
                    ...
                    <td className="px-4 py-2.5">
                      <Link href={`/q/${m.token}`} className="font-medium hover:text-cyan-300">
                        {m.nameEn}
                      </Link>
      ...
      <p className="mt-8 text-sm text-slate-500">
        ...
        <Link href="/admin/issues" className="text-cyan-300 hover:underline">
          Open issues
        </Link>
      </p>
    </main>
